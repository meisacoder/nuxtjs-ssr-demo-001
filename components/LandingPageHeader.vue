...
<template>
  ...
  <nav
    ...
    <div class="lg:container mx-auto flex w-full flex-wrap items-center justify-between px-3">
      ...
      <div class="dropdown inline-block relative ml-auto">
        ...
        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
          <!--rounded-b-->
          <li><nuxt-link to="/" class="w-full bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Home</nuxt-link></li>
          <li><nuxt-link to="/about" class="w-full bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">About</nuxt-link></li>
          <!-- class="loginBtn  -->
          <li v-if="!authenticated" class="w-full  bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" style="float: right">
